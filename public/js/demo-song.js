...
document.addEventListener("DOMContentLoaded", (event) => {
  ...
  let fingerboardWrapper = document.getElementsByClassName('fingerboard-wrapper')[0];
  ...
  let demoSongButton = document.getElementsByClassName('demoSongButton')[0];
  let bpmSelectionButtonsWrapper = document.getElementsByClassName('bpm-selection-demo-wrapper')[0];
  fingerboardWrapper.style.display = 'none';
  ...
  $('.bpmSelectionButton').on('click', (event) => {
    ...
    // toggleLiveInput();
    fingerboardWrapper.style.display = null;
  })
  demoSongButton.addEventListener('click', (event) => {
    console.log('button was clicked')
    let currentSongRawData = newSongNoteList;
    ...
    songScrollBox.style.display = null;
    bpmSelectionButtonsWrapper.style.display = null;
  })
});
